<template>
  <div class="translate-form" v-show="showTranslate">
    ...
    <span class="trans-char-count fr db"> 
        {{ sourceText.length }} / 1000 
    </span>

    <textarea v-model="targetText" placeholder="Target Text"></textarea>
